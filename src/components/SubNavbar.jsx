...
import { RiTruckFill, RiStore2Fill, RiArrowDownSFill, RiMapPin2Fill } from "@remixicon/react";
            ...
            <div className="flex w-full max-w-7xl">
                <ul className="flex items-center gap-0 md:gap-3">
                    <li className="flex items-center gap-1 md:gap-3">
                        ...
                        <button className="flex items-center md:gap-2 px-3 h-10 rounded-full hover:bg-black/5 cursor-pointer">
                            <span className="hidden md:inline">Selecciona tu ubicación</span>
                            <span className="block md:hidden"><RiMapPin2Fill /></span>
