    ...
    return (
        <div className="flex min-h-[calc(100svh-168px)] w-full justify-center items-start">
            <section className="flex flex-col w-full max-w-7xl gap-5">
                <div className="breadcrumb h-13 flex items-center px-5 md:px-0 uppercase font-medium text-sm">
                    <Breadcrumb>
                        <BreadcrumbList>
                            <BreadcrumbItem>
                ...
                <div className="grid md:grid-cols-3 lg:grid-cols-4 w-full">
                    <aside className="md:sticky md:top-42 self-start flex flex-col md:col-span-1 lg:col-span-1 pe-5 gap-5 md:border-r">
